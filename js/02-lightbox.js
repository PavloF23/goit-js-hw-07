...
const galleryRefs = document.querySelector('.gallery');  // посиляння на розмітку в HTML
const galleryItemsRefs = galleryItemsMarkup(galleryItems); // додавання картинок в розмітку HTML

galleryRefs.innerHTML = galleryItemsRefs;  //  додавання розмитки на сторінку

// Створеня розміткі HTML
